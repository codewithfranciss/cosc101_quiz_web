...
export default function DepartmentScores() {
  ...
  const [filteredScores, setFilteredScores] = useState<{ matric_number: string; full_name: string; score: number }[]>([]);
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Score (/30)</TableHead>
                  <TableHead>Score (/15)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
